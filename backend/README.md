...
## Project Structure
    ...
    ├── la_canine_concierge_40303  # Django project configurations
...
1. Clone this repo and `cd la_canine_concierge_40303`
...
2. Clone this repo and `cd la_canine_concierge_40303`
